...
echo "📖 Reading subagent prompt from $AGENT_FILE..."
...
echo "📚 Loading full file contents..."
FULL_FILES_CONTENT=""
...
---
*🤖 Generated by Gemini ($GEMINI_MODEL) impersonating \`$SUBAGENT\`*
*📊 PR #$PR_NUMBER • $FILE_COUNT files changed*
"
...
echo ""
echo "🎉 Gemini subagent impersonation complete!"
